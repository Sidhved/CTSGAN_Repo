...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--input',
        nargs='+',
        default=['datasets/Brain_Tumor/Brain_Tumor', 'datasets/Brain_Tumor/Brain_Tumor_multiscale'],
        help='Input folder, can be a list')
    parser.add_argument(
        '--root',
        nargs='+',
        default=['datasets/Brain_Tumor', 'datasets/Brain_Tumor'],
        help='Folder root, should have the length as input folders')
    parser.add_argument(
        '--meta_info',
        type=str,
        default='datasets/Brain_Tumor/meta_info/meta_info_Brain_Tumor_multiscale.txt',
