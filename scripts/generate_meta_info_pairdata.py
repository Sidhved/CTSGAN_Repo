...
def main(args):
    ...
    assert len(img_paths_gt) == len(img_paths_lq), ('GT folder and LQ folder should have the same length, but got 'f'{len(img_paths_gt)} and {len(img_paths_lq)}.')
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--input',
        nargs='+',
        default=['datasets/Brain_Tumor/Brain_Tumor_sub', 'datasets/Brain_Tumor/Brain_Tumor_train_LR_bicubic_X4_sub'],
    ...
    parser.add_argument(
        '--meta_info',
        type=str,
        default='datasets/Brain_Tumor/meta_info/meta_info_Brain_Tumor_sub_pair.txt',
